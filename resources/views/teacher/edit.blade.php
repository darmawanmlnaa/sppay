            ...
            <div class="card-body">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        @if ($user->thumb)
                            <img src="{{ asset('storage/'.$user->thumb) }}" class="img-priview img-fluid mb-3 col-sm-5 d-block">
                        @else
                            <img class="img-priview img-fluid mb-3 col-sm-5">
                        @endif
                        <input type="file" id="thumb" name="thumb" class="form-control @error('thumb') is-invalid @enderror" onchange="priviewImage()" value="{{ $user->thumb }}">
