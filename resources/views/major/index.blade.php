    ...
    <div class="section-body">
        ...
        <div class="card">
            <div class="card-header">
                <a href="{{ route('major.create') }}" class="btn btn-icon icon-left btn-primary"><i class="fas fa-plus"></i> Tambah</a>
            </div>
            <div class="card-body">
                            ...
                            @foreach ($majors as $key => $get)
                                <tr>
                                    <td>
                                        <div class="row d-fex justify-content-center">
                                            <a href="major/edit/{{ $get->id }}" class="btn btn-icon btn-primary mx-2"><i class="far fa-edit"></i></a>
                                ...
                                <div class="modal fade" id="deleteModal{{$get->id}}" data-backdrop="false" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <h5 class="modal-title" id="staticBackdropLabel">Konfirmasi hapus jurusan</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                        </div>
                                        <div class="modal-body">
                                            Apa anda yakin ingin menghapus jurusan <b>{{ $get->major }}</b> ?
                                        </div>
